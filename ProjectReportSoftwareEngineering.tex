        ...
        \item \textbf{MapActivity:}
                \begin{itemize}
                    ...
                    \item public void onMapReady()
                        ...
                        This method is used by the Map interface to initialize values.
                    \item private String getUrl()
                    
                        The method is used to get the url from the google servers.
                    \item public boolean checkLocationPermission()
                    
                        Method is for check the if the user has given the app permission to  use the onboard location serivces.
                    
                    \item public void onConnectionFailed()
                    
                        If the connection fails it produces and error message
                    \item public void onLocationChanged()
                    
                        The method detects the movement of the  user  via the location services and then it update the map marker
                \end{itemize}
        \item \textbf{PaymentActivity:}
                \begin{itemize}
